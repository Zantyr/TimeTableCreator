#the purpose of this file is to ensure the conversions of data flowing from one device to another
...
class Properties(object):
    ...
    def new(self, dev_name,prop_type):
        ...
        for i in xrange(100):
            if "_".join([dev_name,prop_type,str(i)]).replace("-","_") not in prop_names:
